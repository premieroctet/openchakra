...
class creaShop extends React.Component {
  ...
  renderSwitch(stepIndex) {
    ...
    switch(stepIndex) {
      ...
      case 6:
        return <Schedule availabilities={shop.availabilities} services={[]} onCreateAvailability={this.availabilityCreated} onDeleteAvailability={this.availabilityDeleted} title={this.state.title} subtitle={this.state.subtitle} selectable={true} />;
      case 7:
