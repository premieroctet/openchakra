...
class all extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get("http://localhost:3122/myAlfred/api/admin/filterPresentation/all")
            .then((response) => {
    ...
    render() {
        ...
        const row = filterPresentation.map(e => (
            <tr key={e._id}>
                <td>{e.label}</td>
                <td><a href={`/dashboard/filterPresentation/view?id=${e._id}`}>Modifier</a> </td>
            </tr>
        ));
