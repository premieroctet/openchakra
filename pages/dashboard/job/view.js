...
class resetPassword extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://localhost:5000/myAlfred/api/admin/job/all/${id}`)
            .then(response => {
    ...
    onSubmit = e => {
        ...
        const id = this.props.job_id;
        axios.put(`http://localhost:5000/myAlfred/api/admin/job/all/${id}`,{label})
            .then(res => {
    ...
    handleClick() {
        const id = this.props.job_id;
        axios.delete(`http://localhost:5000/myAlfred/api/admin/job/all/${id}`)
            .then(res => {
