                        ...
                        <Paper style={{width: '100%'}}>
                            <div>
                                <Table className={classes.table}>
                                    ...
                                    <TableBody>
                                        {calculating.slice(this.state.page * this.state.rowsPerPage, this.state.page * this.state.rowsPerPage + this.state.rowsPerPage)
                                            .map((e,index) =>
                                                <TableRow key={index}>
                                                    ...
                                                    <TableCell>
                                                        <Link href={`/dashboard/calculating/view?id=${e._id}`}><a>Modifier</a></Link>
                                                    </TableCell>
