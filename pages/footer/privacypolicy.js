                ...
                <Layout>
                   <Grid container style={{marginTop: '6%'}}>
                       <Grid item xs={3} style={{borderRight: '2px solid rgb(206, 206, 206)'}}>
                            <Grid container>
                                {click ?
                                <Grid onClick={this.handleClick} item xs={12} style={{padding: '20px 50px',cursor: 'pointer'}}>
                                ...
                                {click1 ?
                                <Grid onClick={this.handleClick1} item xs={12} style={{padding: '20px 50px',cursor: 'pointer'}}>
                                ...
                                {click2 ?
                                <Grid onClick={this.handleClick2} item xs={12} style={{padding: '20px 50px',cursor: 'pointer'}}>
                                ...
                                {click3 ?
                                <Grid onClick={this.handleClick3} item xs={12} style={{padding: '20px 50px',cursor: 'pointer'}}>
                                ...
                                {click4 ?
                                <Grid onClick={this.handleClick4} item xs={12} style={{padding: '20px 50px',cursor: 'pointer'}}>
                                ...
                                {click5 ?
                                <Grid onClick={this.handleClick5} item xs={12} style={{padding: '20px 50px',cursor: 'pointer'}}>
                                ...
                                {click6 ?
                                <Grid onClick={this.handleClick6} item xs={12} style={{padding: '20px 50px',cursor: 'pointer'}}>
                                ...
                                {click7 ?
                                <Grid onClick={this.handleClick7} item xs={12} style={{padding: '20px 50px',cursor: 'pointer'}}>
                                ...
                                {click8 ?
                                <Grid onClick={this.handleClick8} item xs={12} style={{padding: '20px 50px',cursor: 'pointer'}}>
                                ...
                                {click9 ?
                                <Grid onClick={this.handleClick9} item xs={12} style={{padding: '20px 50px',cursor: 'pointer'}}>
