            ...
            <Grid item xs={9} className={classes.bigContainer}>
              <Grid container>
                <Grid item xs={12} className={classes.responsiveContainer}>
                  <p style={{fontWeight: 'bold', color: '#585858', fontSize: '1.35rem', paddingLeft: '7%'}}>Politique de
                    confidentialité & gestion des cookies</p>
                </Grid>
                {click ?
                  <Grid item xs={12} className={classes.responsiveContainer2}>
                    ...
                    <p style={{
                      ...
                      paddingRight: '30%',
                      textAlign: 'justify',
                    }}>La politique de confidentialité permet d’informer nos visiteurs et membres au regard de notre
                      ...
                      la gestion des cookies, qui se fait par acceptation sur le site web.
                    </p>
                  </Grid>
                  : null}
              </Grid>
