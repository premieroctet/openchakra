            ...
            <Layout>
                <Grid container className={classes.hideed} style={{marginTop:80,  textAlign: 'justify'}}>
                    ...
                    <Grid item xs={12}>
                        ...
                        <p>4.4 Pour ce faire, la Place de marché My-Alfred s’appuie sur le tiers de confiance MangoPay pour le paiement des Prestations de service. En utilisant ce système de paiement, les Membres acceptent les conditions de MangoPay disponibles ici. Pour toutes questions et conditions relatives au paiement des Prestations de services, les Membres devront se référer aux conditions d’utilisation du tiers de confiance MangoPay.
                        ...
                        Parmi les Alfred, sont présentés en priorité X réponses provenant d’Alfred dont l’évaluation est égale à 5 étoiles et dans un périmètre de X km, puis X réponses provenant d’Alfred dont la proximité et le nombre d’étoiles sont décroissant [il faut préciser comment cela s’organise]. </p>
                    ...
                    <Grid item xs={12}>
                        ...
                        Les Membres sont d’ores et déjà invités à se référer aux informations figurant :
                            <div style={{paddingLeft: '15px'}}>
                                <br/>- sur <a className={classes.a} target="_blank" href="www.impots.gouv.fr">www.impots.gouv.fr</a> concernant leurs obligations fiscales et plus particulièrement la page <a className={classes.a} target="_blank" href="https://www.impots.gouv.fr/portail/node/10841">https://www.impots.gouv.fr/portail/node/10841</a>.
                                <br/>- sur <a className={classes.a} target="_blank" href="www.urssaf.fr">www.urssaf.fr</a> concernant leurs obligations sociales et plus particulièrement la page <a className={classes.a} target="_blank" href="https://www.urssaf.fr/portail/home/espaces-dedies/activites-relevant-de-leconomie.htm">https://www.urssaf.fr/portail/home/espaces-dedies/activites-relevant-de-leconomie.htm</a>.
                            </div>
