              ...
              <Grid container className={classes.bigContainer}>
                ...
                <Grid container>
                  <Grid className={classes.toggle}>
                    <Grid>
                      <ResponsiveDrawer ref={this.child} isActiveIndex={false} itemsDrawers={'reservation'}
                                        needMargin={true}/>
                    </Grid>
                    <Grid>
                      <Grid>
                  ...
                  <Grid className={classes.Rightcontent} item xs={12} sm={9} md={7}>
                    ...
                    <Grid container className={classes.mainContainerAbout}>
                      <Grid item xs={12} md={7}>
                        <About
                          alfred={currentUser._id === bookingObj.alfred._id ? bookingObj.user._id : bookingObj.alfred._id}/>
                      </Grid>
                        ...
                        <Grid item>
                          <Grid container>
                            <Grid className={classes.detailsReservationContainer} style={{alignItems: 'center'}}>
                              <Grid item>
                                <Grid style={{width: 80, display: 'flex', justifyContent: 'center'}}>
                                  <img style={{width: 50, height: 50}} alt={'commentary'} title={'commentary'}
                            ...
                            <Grid className={classes.detailsReservationContainer} style={{alignItems: 'center'}}>
                              <Grid item>
                                <Grid style={{width: 80, display: 'flex', justifyContent: 'center'}}>
                                  <img style={{width: 50, height: 50}} alt={'adresse'} title={'adresse'}
                                       src={'../../static/assets/img/userServicePreview/adresse.svg'}/>
                                </Grid>
                              </Grid>
                              <Grid item style={{paddingLeft: '3%'}}>
                            ...
                            <Grid className={classes.detailsReservationContainer}>
                              <Grid item>
                                <Grid style={{width: 80}}>
                                  <img style={{width: 80, height: 80}} alt={categoryLabel} title={categoryLabel}
                                       src={`../../static/assets/img/castorJobs/${categoryLabel}.svg`}/>
                                </Grid>
                              </Grid>
                              ...
                              currentUser._id === bookingObj.alfred._id ? (
                                ...
                                <Link href={`reserve?id=${bookingObj._id}`}>
                                  <Button variant={'contained'} color={'secondary'}
                                          style={{color: 'white'}}>Réserver</Button>
                                </Link>
                              )
                            ) : null}
                          </Grid>
