    ...
    render() {
        ...
        return (
            <Fragment>
                <Layout>
                    <Grid container className={classes.bigContainer}>
                        ...
                        <Grid container style={{marginBottom: '10%'}}>
                            <Grid className={classes.toggle}  item xs={3} style={{ height: '100%', borderRight: '1px #8281813b solid',}}>
                            ...
                            <Grid className={classes.Rightcontent} item xs={9} sm={9} md={7}>
                                ...
                                <Grid container className={classes.mobilerow} style={{borderBottom: '1.5px #8281813b solid', marginTop:'5%'}}>
                                    <Grid item xs={3} md={1} style={{marginRight: '5%'}}>
                                        {bookingObj === null || currentUser === null ?
                                            ...
                                            currentUser._id === bookingObj.alfred._id ?
                                                <img src={`../../${bookingObj.user.picture}`} alt={'picture'} style={{width: '80px', height: '80px',borderRadius: '50%', objectFit:'cover', marginBottom: '20px'}}></img>
                                                :
                                                <img src={`../../${bookingObj.alfred.picture}`} alt={'picture'} style={{width: '80px', height: '80px',borderRadius: '50%', objectFit:'cover', marginBottom: '20px'}}></img>
                                        }
                                    </Grid>
                                    <Grid item xs={5} md={7}>
                                        ...
                                        <Typography style={{color: '#4FBDD7', fontWeight: '600', fontSize: '1.1rem'}}>{bookingObj === null || currentUser === null ? null : currentUser._id === bookingObj.alfred._id ? (bookingObj.amount - (bookingObj.fees * 2)).toFixed(2) : bookingObj.amount}€</Typography>
                                    ...
                                    <Grid item xs={2} style={{textAlign: 'center'}}>
                                        <div style={{marginTop: '5%'}}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20.432" height="31.478" viewBox="0 0 55.432 66.478">
                                ...
                                <Grid container style={{borderBottom: '1.5px #8281813b solid', marginTop:'5%', paddingBottom: '7%'}}>
                                    <Grid item xs={5} md={7}>
                                        <Typography style={{marginTop: '-3%', fontSize: '1.7rem'}}>A propos de {bookingObj === null || currentUser === null ? null : currentUser._id === bookingObj.alfred._id ? <span>{`${bookingObj.user.firstname} ${bookingObj.user.name}`}</span> : <span>{`${bookingObj.alfred.firstname} ${bookingObj.alfred.name}`}</span>}</Typography>
                                        <div style={{marginLeft: '3%'}}>
                                        <img style={{width:'20px', marginRight: '3px', marginBottom: '5px'}} src='../../static/stars/star-solid.png'></img>
                                        <img style={{width:'20px', marginRight: '3px', marginBottom: '5px'}} src='../../static/stars/star-solid.png'></img>
                                        <img style={{width:'20px', marginRight: '3px', marginBottom: '5px'}} src='../../static/stars/star-solid.png'></img>
                                        <img style={{width:'20px', marginRight: '3px', marginBottom: '5px'}} src='../../static/stars/star-regular.png'></img>
                                        <img style={{width:'20px', marginRight: '3px', marginBottom: '5px'}} src='../../static/stars/star-regular.png'></img>

                                        
                                        {/*<Rating
                                            emptySymbol={<img style={{width: '20px', marginRight: '3px'}} src="../../static/stars/star-regular.png" className="icon" />}
                                            fullSymbol={<img style={{width: '20px', marginRight: '3px'}} src="../../static/stars/star-solid.png" className="icon" />}
                                            {...this.props}
                                            ...
                                            <Grid style={{marginLeft:'4%'}} container>
                                                ...
                                                {bookingObj === null || currentUser === null ?
                                                        ...
                                                        bookingObj.user.id_confirmed === true ?
                                                            <>
                                                                <Grid item xs={1}>
                                                                    <img style={{width:'15px'}} src='../../static/statut/oui.png'></img>
                                                                </Grid>
                                                                <Grid item xs={11}>
                                                                    <Typography style={{ fontSize: '0.8rem', marginLeft: '-5%'}}>Pièce d’identité vérifiée</Typography>
                                                                </Grid>
                                                            </>
                                                            :
                                                            null
                                                ...
                                                {bookingObj === null || currentUser === null ?
                                                        ...
                                                        currentUser._id === bookingObj.alfred._id ?
                                                            <>
                                                                <Grid item xs={1}>
                                                                    <img style={{width:'15px'}} src='../../static/statut/calendar.png'></img>
                                                                </Grid>
                                                                <Grid item xs={11}>
                                                                    <Typography style={{ fontSize: '0.8rem', marginLeft: '-5%'}}>Membre depuis le {moment(bookingObj.user.creation_date).format('DD/MM/YYYY')}</Typography>
                                                                </Grid>
                                                            </>
                                                            :
                                                            <>
                                                                ...
                                                                <Grid item xs={11}>
                                                                    <Typography style={{ fontSize: '0.8rem', marginLeft: '-5%'}}>Membre depuis le {moment(bookingObj.alfred.creation_date).format('DD/MM/YYYY')}</Typography>
                                                                </Grid>
                                                            </>
                                                ...
                                                {bookingObj === null ?
                                                    null
                                                    :
                                                    bookingObj.alfred.is_alfred === true && bookingObj.user.is_alfred === true ?
                                                        <>
                                                            <Grid item xs={1}>
                                                                <img style={{width:'15px'}} src='../../static/statut/beaver.png'></img>
                                                            </Grid>
                                                            <Grid item xs={11}>
                                                                <Typography style={{ fontSize: '0.8rem', marginLeft: '-5%'}}>Il est également Alfred </Typography>
                                                            </Grid>
                                                        </>
                                                        :
                                                        null
                                                ...
                                                {bookingObj === null || currentUser === null ?
                                                    ...
                                                    currentUser._id === bookingObj.alfred._id ?
                                                        <>
                                                            <Grid item xs={1}>
                                                                <img style={{width:'15px'}} src='../../static/statut/chat.png'></img>
                                                            </Grid>
                                                            <Grid item xs={11}>
                                                                <Typography style={{ fontSize: '0.8rem', marginLeft: '-5%'}}>Langue: {bookingObj.user.languages.length ? bookingObj.user.languages.map(language => language + ', ') : <span>Français</span> } </Typography>
                                                            </Grid>
                                                        </>
                                                        :
                                                        <>
                                                            ...
                                                            <Grid item xs={11}>
                                                                <Typography style={{ fontSize: '0.8rem', marginLeft: '-5%'}}>Langue: {bookingObj.alfred.languages.length ? bookingObj.alfred.languages.map(language => language + ', ') : <span>Français</span> } </Typography>
                                                            </Grid>
                                                        </>
                                                }
                                              ...
                                              <div style={{textAlign: 'center', width: '200px'}}>
                                                {bookingObj === null || currentUser === null ?
                                                    ...
                                                    currentUser._id === bookingObj.alfred._id ?
                                                        ...
                                                        :
                                                        <Typography>{bookingObj.alfred.phone}</Typography>
                                    ...
                                    <Grid item xs={5} md={9}>
                                        ...
                                        <Grid container>
                                            <Grid item xs={1} style={{textAlign: 'center'}}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="33.759" height="30.269" viewBox="0 0 83.759 80.269">
                                                    <g id="Groupe_1096" data-name="Groupe 1096" transform="translate(0 23)">
                                                        <path id="Tracé_12590" data-name="Tracé 12590" d="M16.118-19.843l.889.254.889.5.634.509.634.763.384.758.249.888.13,1.018-.13.888-.249.883-.384.763-.634.763-.634.5-.889.509-.889.254-.889.125-.889-.125-.889-.254-.889-.509-.634-.5-.634-.763-.379-.763-.255-.883-.125-.888.125-1.018.255-.888.379-.758.634-.763.634-.509.889-.5.889-.254Zm53.3,0,.889.254.889.5.634.509.634.763.379.758.255.888.13,1.018-.13.888-.255.883-.379.763-.634.763-.634.5-.889.509-.889.254-.888.125-.889-.125-.888-.254-.889-.509-.634-.5-.634-.763-.379-.763-.255-.883-.13-.888.13-1.018.255-.888.379-.758.634-.763.634-.509.889-.5.888-.254ZM0-22V-8.049H83.759V-22Z" transform="translate(0 2.494)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12591" data-name="Tracé 12591" d="M0-2V.682l.13.939.255.807.379.67.379.67.634.538.764.4.759.269h77.16l.759-.269.764-.4.634-.538.379-.67.379-.67.255-.807.13-.939V-2l-.13.939-.255.8-.379.67-.379.67-.634.538-.764.4-.759.269H3.3l-.759-.269-.764-.4-.634-.538L.764.412.385-.258l-.255-.8Z" transform="translate(0 52.293)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12592" data-name="Tracé 12592" d="M5.327-23l-.583.269-.434.132-.434.407-.434.4-.149.4L3-20.851v9.662l.292.539.149.4.434.4.434.407.434.132.583.269H7.653L8.23-9.31l.44-.132.434-.407.434-.4.149-.4.292-.539v-9.662l-.292-.539-.149-.4-.434-.4L8.671-22.6l-.44-.132L7.653-23Z" transform="translate(7.47 0)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12593" data-name="Tracé 12593" d="M20.326-23l-.583.269-.434.132-.44.407-.434.4-.143.4L18-20.851v9.662l.291.539.143.4.434.4.44.407.434.132.583.269h2.319l.583-.269.434-.132.44-.407.434-.4.143-.4.291-.539v-9.662l-.291-.539-.143-.4-.434-.4-.44-.407-.434-.132L22.645-23Z" transform="translate(44.823 0)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12594" data-name="Tracé 12594" d="M7-11V2.949H17.465V-11Z" transform="translate(17.43 29.884)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12595" data-name="Tracé 12595" d="M7-14V-3.539H17.465V-14Z" transform="translate(17.43 22.413)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12596" data-name="Tracé 12596" d="M7-7V3.461H17.465V-7Z" transform="translate(17.43 39.843)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12597" data-name="Tracé 12597" d="M10-7V3.461H20.461V-7Z" transform="translate(24.903 39.843)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12598" data-name="Tracé 12598" d="M3-11V2.949H13.466V-11Z" transform="translate(7.474 29.884)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12599" data-name="Tracé 12599" d="M3-7V3.461H13.466V-7Z" transform="translate(7.474 39.843)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12600" data-name="Tracé 12600" d="M3-14V-3.539H13.466V-14Z" transform="translate(7.474 22.413)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12601" data-name="Tracé 12601" d="M10-11V2.949H20.461V-11Z" transform="translate(24.903 29.884)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12602" data-name="Tracé 12602" d="M75-9.506l.384.251.255.5.125.5V30.218l-.125.5-.255.378L75,31.338l-.5.128H9.264l-.5-.128-.385-.245-.249-.378-.13-.5V-8.258l.13-.5.249-.5.385-.251ZM0-17V35.838l.13.5.255.5.379.5.379.5.634.378.764.373.759.251h77.16l.759-.251.764-.373.634-.5.379-.624.379-.624.255-.752.13-.875V-17Z" transform="translate(0 14.943)" fill="#FBAEB6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12603" data-name="Tracé 12603" d="M18-7V3.461H28.47V-7Z" transform="translate(44.819 39.843)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12604" data-name="Tracé 12604" d="M18-11V2.949H28.47V-11Z" transform="translate(44.819 29.884)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12605" data-name="Tracé 12605" d="M18-14V-3.539H28.47V-14Z" transform="translate(44.819 22.413)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12606" data-name="Tracé 12606" d="M14-7V3.461H24.466V-7Z" transform="translate(34.863 39.843)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12607" data-name="Tracé 12607" d="M10-14V-3.539H20.461V-14Z" transform="translate(24.903 22.413)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12608" data-name="Tracé 12608" d="M14-11V2.949H24.466V-11Z" transform="translate(34.863 29.884)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                        <path id="Tracé_12609" data-name="Tracé 12609" d="M14-14V-3.539H24.466V-14Z" transform="translate(34.863 22.413)" fill="#fbaeb6" fill-rule="evenodd"/>
                                                    </g>
                                                </svg>
                                            </Grid>
                                            ...
                                            <Grid item xs={1} style={{textAlign: 'center', marginTop: '3%'}}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25.432" height="36.478" viewBox="0 0 55.432 66.478">
                                                    <path id="Tracé_12517" data-name="Tracé 12517" d="M300.251,5274l-1.352.1-1.352.2-1.463.206-1.241.311-1.352.3-2.59.814-2.362,1.125-2.365,1.223-2.03,1.428-2.03,1.633-1.8,1.832-1.577,1.836-1.352,2.141-1.238,2.144-.9,2.34-.339,1.227-.339,1.121-.225,1.329-.228,1.222L274,5297.76v1.323l.111,1.835.228,1.833.336,1.942.567,1.831.564,1.839.788,1.832.788,1.836.9,1.838,1.016,1.731,1.124,1.832,2.368,3.365,2.476,3.267,2.593,3.061,2.59,2.851,2.479,2.552,2.365,2.344,2.14,1.936,3.04,2.653,1.241,1.018,1.241-1.018,3.04-2.653,2.141-1.936,2.365-2.344,2.479-2.552,2.59-2.851,2.593-3.061,2.476-3.267,2.368-3.365,1.124-1.832,1.016-1.731.9-1.838.788-1.836.788-1.832.564-1.839.567-1.831.336-1.942.228-1.833.111-1.835v-1.323l-.111-1.225-.228-1.222-.225-1.329-.339-1.121-.339-1.227-.9-2.34-1.238-2.144-1.352-2.141-1.577-1.836-1.8-1.832-2.03-1.633-2.03-1.428-2.365-1.223-2.362-1.125-2.59-.814-1.352-.3-1.241-.311-1.463-.206-1.352-.2-1.355-.1Zm2.707,14.378,1.124.2,1.127.206,1.124.4,1.016.41,1.013.61.9.611.788.714.792.715.678.813.671.919.453.919.453,1.018.225,1.021.222,1.023v2.24l-.222,1.02-.225,1.018-.453,1.023-.453.912-.671.919-.678.819-.792.713-.788.715-.9.609-1.013.613-1.016.4-1.124.41-1.127.206-1.124.2h-2.483l-1.124-.2-1.127-.206-1.124-.41-1.016-.4-1.013-.613-.9-.609-.788-.715-.792-.713-.678-.819-.671-.919-.453-.912-.453-1.023-.225-1.018-.222-1.02v-2.24l.222-1.023.225-1.021.453-1.018.453-.919.671-.919.678-.812.792-.715.788-.714.9-.611,1.013-.61,1.016-.41,1.124-.4,1.127-.206,1.124-.2Z" transform="translate(-274.001 -5274)" fill="#FBAEB6" fill-rule="evenodd"/>
                                                </svg>
                                            </Grid>
                                            <Grid item xs={11} style={{paddingLeft: '3%',marginTop: '3%'}}>
                                                <Typography>
                                                    {bookingObj === null ?
                                                        null
                                                        :
                                                    ...
                                                    {bookingObj === null ?
                                                        null
                                                        :
                                                        bookingObj.address.zip_code + ' ' + bookingObj.address.city
                                                    } 
                                                </Typography>
                                                <Typography style={{color: 'rgb(47, 188, 211)', fontSize: '0.8rem', cursor: 'pointer'}}>Voir sur la map</Typography>
                                            </Grid>
                                        </Grid>
                                            ...
                                            bookingObj.status === 'En attente de confirmation' ?
                                                currentUser._id === bookingObj.alfred._id ?
                                                    <>
                                                        ...
                                                        <div style={{textAlign: 'center', height: '40px', minWidth: '250px', lineHeight: 2.5, borderRadius: '50px', border: '1px solid black', marginTop: '20%'}}>
                                                            <Link href='#'>
                                                                <a style={{textDecoration:'none', color: 'black' }}>Refuser</a>
                                                            </Link>
                                                        </div>
                                                    </>
                                                    :
                                ...
                                <Grid container style={{borderBottom: '1.5px #8281813b solid', marginTop:'5%', paddingBottom: '7%'}}>
                                    ...
                                    <Grid item xs={9}>
                                        <Grid container>
                                            ...
                                            <Grid item xs={7}></Grid>
                                            <Grid item xs={1}>
                                                <Typography style={{fontSize: '1.1rem', textAlign:'center'}}>Qté</Typography>
                                            </Grid>
                                            <Grid item xs={2}>
                                                <Typography style={{fontSize: '1.1rem', textAlign:'center'}}>Prix unitaire</Typography>
                                            </Grid>
                                        </Grid>
                                    ...
                                    {bookingObj === null ?
                                      ...
                                      bookingObj.equipments.length ?
                                        bookingObj.equipments.map(equipment => {
                                          return (
                                            <Grid item xs={1} style={{textAlign: 'center'}}>
                                              <img style={{width: '98%'}} src={`../../static/equipments/${equipment.logo.slice(0, -4)}_Selected.svg`}/>
                                            </Grid>
                                          )
                                        })
                                        :
                                ...
                                <Grid container style={{borderBottom: '1.5px #8281813b solid', marginTop:'5%', paddingBottom: '7%'}}>
                                    ...
                                    <Grid item xs={12}><Typography style={{fontSize: '1.4rem'}}>{bookingObj === null || currentUser === null ? null : currentUser._id === bookingObj.alfred._id ? (bookingObj.amount - (bookingObj.fees * 2)).toFixed(2) : bookingObj.amount}€</Typography></Grid>
                                    ...
                                    >
                                        ...
                                        >
                                            <Typography style={{fontSize: '0.8rem', color: 'rgb(47, 188, 211)'}}>voir détail</Typography>
                                        </ExpansionPanelSummary> 
                                            ...
                                            <Grid container>
                                                ...
                                                <Grid item xs={2}>
                                                  {bookingObj === null ?
                                                    ...
                                                    <Typography style={{fontSize: '1.1rem', textAlign:'center', marginTop: '10px'}}>{bookingObj === null || currentUser === null ? null : currentUser._id === bookingObj.alfred._id ? <span>- {bookingObj.fees}</span> : <span>+ {bookingObj.fees}</span> }€</Typography>
                                                    <Typography style={{fontSize: '1.5rem',fontWeight: 'bold', color: 'rgb(47, 188, 211)', textAlign:'center', marginTop: '10px'}}>{bookingObj === null || currentUser === null ? null : currentUser._id === bookingObj.alfred._id ? (bookingObj.amount - (bookingObj.fees * 2)).toFixed(2) : bookingObj.amount}€</Typography>
                                                </Grid>
                                            </Grid> 
                                        </ExpansionPanelDetails>
                                    </ExpansionPanel>
                ...
                {modal1 ?<React.Fragment>
                <Grid onClick={() => this.handleClose()} style={{height: '100%',width: '250vh', position: 'fixed', background: '#82818191', zIndex: '9999', top: 0, }}></Grid>
                <Grid style={{height: '400px',width: '700px', position: 'fixed', background: '#f1f1f1', zIndex: '99999', top: '25%',left:0,right: 0, margin: 'auto' }}>
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/RK1K2bCg4J8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"></iframe>
                </Grid></React.Fragment> : null}

                {modal2 ? <React.Fragment>
                <Grid onClick={() => this.handleClose()} style={{height: '100%',width: '250vh', position: 'fixed', background: '#82818191', zIndex: '9999', top: 0, }}></Grid>
                <Grid style={{height: '400px',width: '700px', position: 'fixed', background: '#f1f1f1', zIndex: '99999', top: '25%',left:0,right: 0, margin: 'auto' }}>
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/RK1K2bCg4J8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"></iframe>
                </Grid></React.Fragment> : null}

                {modal3 ? <React.Fragment>
                <Grid onClick={() => this.handleClose()} style={{height: '100%',width: '250vh', position: 'fixed', background: '#82818191', zIndex: '9999', top: 0, }}></Grid>
                <Grid style={{height: '400px',width: '700px', position: 'fixed', background: '#f1f1f1', zIndex: '99999', top: '25%',left:0,right: 0, margin: 'auto' }}>
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/RK1K2bCg4J8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"></iframe>
                </Grid></React.Fragment> : null}

                {modal4 ? <React.Fragment>
                <Grid onClick={() => this.handleClose()} style={{height: '100%',width: '250vh', position: 'fixed', background: '#82818191', zIndex: '9999', top: 0, }}></Grid>
                <Grid style={{height: '400px',width: '700px', position: 'fixed', background: '#f1f1f1', zIndex: '99999', top: '25%',left:0,right: 0, margin: 'auto' }}>
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/RK1K2bCg4J8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"></iframe>
                </Grid></React.Fragment> : null}
