...
class addOtherAddress extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            address: '',
    ...
    onSubmit = e => {
        ...
        axios
            .put('http://localhost:5000/myAlfred/api/users/profile/serviceAddress', newAddress)
            .then(res => {
...
export default withStyles(styles)(addOtherAddress);
