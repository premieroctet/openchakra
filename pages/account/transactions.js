      ...
      <Fragment>
        <Helmet>
          ...
          <meta property="description"
                content="Retrouvez l'ensemble des services rémunérés que vous avez consommé sur My Alfred depuis votre historique des transactions. My Alfred des services entre particuliers assurés, un paiement sécurisé ! "/>
        </Helmet>
        <Layout>
              ...
              <Grid container className={classes.tabweb} style={{paddingRight: 20}}>
                ...
                <Grid item xs={6} style={{textAlign: 'center'}}>
                  <h2 onClick={this.handleClicktabs} style={{
                    ...
                    marginLeft: '0%',
                    position: 'sticky',
                  }}>Commandes passées</h2>
                </Grid>
                <Grid item xs={6} style={{textAlign: 'center'}}>
                  <h2 onClick={this.handleClicktabs2} style={{
                    color: '#828181',
                    fontWeight: '100',
                    cursor: 'pointer',
                    marginLeft: '0%',
                    position: 'sticky',
                  }}>Commandes à venir</h2><br/>
                </Grid>
              ...
              <Grid container className={classes.tabmobile}>
                <Grid item xs={6} style={{textAlign: 'center'}}>
                  <h2 onClick={this.handleClicktabs}
                      style={{color: '#828181', fontWeight: '100', cursor: 'pointer', marginLeft: '25%'}}>Commandes
                    passées</h2>
                </Grid>
                <Grid item xs={6}>
                  <h2 onClick={this.handleClicktabs2}
                      style={{color: '#828181', fontWeight: '100', textAlign: 'center', cursor: 'pointer'}}>Commandes à
                    venir</h2><br/>
                </Grid>
                        ...
                        <Grid key={index} container style={{borderBottom: '#9f919178 solid 1px', padding: '20px 0'}}>
                          <Grid item xs={8}>
                            ...
                            <Typography style={{
                              marginBottom: '30px',
                              fontSize: '1.1rem',
                            }}>{e.alfred.firstname} - {e.date_prestation} - {e.service}</Typography>
                          </Grid>
                          <Grid item xs={4}>
                            <Typography style={{
                              color: '#26A7C6',
                        ...
                        <Grid key={index} container style={{borderBottom: '#9f919178 solid 1px', padding: '20px 0'}}>
                          <Grid item xs={8}>
                            <Typography style={{
                              marginBottom: '30px',
                              fontSize: '1.1rem',
                            }}>{moment(e.date_payment).format('DD/MM/YYYY')}</Typography>
                            <Typography style={{
                              marginBottom: '30px',
                              fontSize: '1.1rem',
                            }}>{e.alfred.firstname} - {e.date_prestation} - {e.service}</Typography>
