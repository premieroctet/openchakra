          ...
          <Grid container className={classes.bigContainer}>
            ...
            <Grid item xs={9} className={classes.containerLeft}>
              ...
              <Grid>
                ...
                <Grid item xs={7}>
                  <p>
                    Pour la sécurité de votre compte, votre mot de passe doit contenir 8 caractères minimum dont une
                ...
                <Grid style={{display: 'flex'}}>
                  ...
                  <Grid className={classes.picsContainer} item>
                    <img style={{width: '40%', height: '100%'}} alt={'Photo'}
                         src={'../../static/mot-de-passe-picto.svg'}/>
                  </Grid>
                </Grid>
                <Grid item style={{display: 'flex', justifyContent: 'left'}}>
                ...
                <Grid container>
                  <Grid item xs={12} md={6}
                        style={{display: 'flex', border: '1px darkgray solid', padding: 25, marginBottom: 20}}>
                    <Grid container>
