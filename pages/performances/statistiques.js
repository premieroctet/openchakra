      ...
      <Fragment>
        <Layout>
          <Grid container className={classes.bigContainer}>
            ...
            <Grid item className={classes.myStat}>
              <Grid container className={classes.mainContainer}>
                <Grid item>
                  <h1 style={{color: '#7E7E7E', fontWeight: '100'}}>Mes statistiques</h1>
                </Grid>
                <Grid container className={classes.containerStatistique}>
                  <Grid item className={classes.webview}/>
                  <Grid item style={{textAlign: 'center', padding: 10}}>
                    <Typography style={{color: '#7E7E7E'}}><span style={{
                      color: '#2FBCD3',
                      fontSize: '1.1rem',
                      fontWeight: 'bold',
                    }}>{this.state.totalIncomes.toFixed(2)}€</span> <br/>Générés depuis l'inscription</Typography>
                  </Grid>
                  <Grid item style={{textAlign: 'center', padding: 10}}>
                    <Typography style={{color: '#7E7E7E'}}><span style={{
                      color: '#2FBCD3',
                      fontSize: '1.1rem',
                      fontWeight: 'bold',
                    }}>{this.state.totalPrestations}</span> <br/>Prestation(s) réalisée(s)</Typography>
                  </Grid>
                  <Grid item style={{textAlign: 'center', padding: 10}}>
                    <Typography style={{color: '#7E7E7E'}}><span style={{
                      color: '#2FBCD3',
                      fontSize: '1.1rem',
                      fontWeight: 'bold',
                    }}>{this.state.totalViewsServices}</span> <br/>Vue(s) de vos services depuis
                      l'inscription</Typography>
                  </Grid>
                  <Grid item style={{textAlign: 'center', padding: 10}}>
                    <Typography style={{color: '#7E7E7E'}}><span style={{
                      color: '#2FBCD3',
                      fontSize: '1.1rem',
                      fontWeight: 'bold',
                    }}>{this.state.totalReviews}</span> <br/>Commentaire(s)</Typography>
                  </Grid>
                </Grid>
                ...
                {uniqCategory.map((u, index) => (
                  ...
                  <React.Fragment key={index}>
                    <Grid container className={classes.containerLabelCategory}>
                      <Grid item>
                      ...
                      if (s.service.category._id === u._id) {
                        return (
                          <Grid key={index2} className={classes.webview} container>
                            <Grid item xs={3}>
                              <Link href={'/myShop/previewService?id=' + s._id}>
                                <a style={{textDecoration: 'none'}}>
                                  <img src={'../../' + s.service.picture}
                                       style={{width: '100%', height: '170px', objectFit: 'cover'}}
                                       alt={s.service.picture} title={s.service.picture}/>
                                </a>
                              </Link>
                            </Grid>
                            <Grid item className={classes.containerDetails}>
                              <Typography
                                style={{fontSize: '1.1rem', marginLeft: '30px'}}>{s.service.label}</Typography>
                              <Grid container style={{marginTop: '20px'}}>
                                <Grid item style={{textAlign: 'center', padding: 10}}>
                                  <Typography style={{color: '#7E7E7E'}}><span style={{
                                    ...
                                    fontSize: '1.1rem',
                                    fontWeight: 'bold',
                                  }}>{this.state[s.service.label + 'Incomes']}€</span> <br/>Générés depuis l'inscription</Typography>
                                </Grid>
                                <Grid item style={{textAlign: 'center', padding: 10}}>
                                  <Typography style={{color: '#7E7E7E'}}><span style={{
                                    color: '#2FBCD3',
                                    fontSize: '1.1rem',
                                    fontWeight: 'bold',
                                  }}>{this.state[s.service.label + 'Prestations']}</span> <br/>Prestation(s) réalisée(s)</Typography>
                                </Grid>
                                <Grid item style={{textAlign: 'center', padding: 10}}>
                                  <Typography style={{color: '#7E7E7E'}}><span style={{
                                    color: '#2FBCD3',
                                    fontSize: '1.1rem',
                                    fontWeight: 'bold',
                                  }}>{s.number_of_views}</span> <br/>Vue(s) du service depuis l'inscription</Typography>
                                </Grid>
                                <Grid item style={{textAlign: 'center', padding: 10}}>
                                  <Typography style={{color: '#7E7E7E'}}><span style={{
                                    color: '#2FBCD3',
                                    fontSize: '1.1rem',
                                    fontWeight: 'bold',
                                  }}>{this.state[s.service.label + 'Reviews']}</span> <br/>Commentaire(s)</Typography>
                                </Grid>
                              </Grid>
                            </Grid>
                          </Grid>
                    ...
                    {serviceUser.map((s, index3) => {
                      if (s.service.category._id === u._id) {
                        return (
                          <Grid key={index3} className={classes.mobileview}
                                style={{boxShadow: '0px 0px 6px #00000024', padding: '15px'}} container>
                            <Grid item xs={12} style={{}}>
                              <img src={'../../' + s.service.picture}
                                   style={{width: '100%', height: '170px', objectFit: 'cover'}}/>
                            </Grid>
                            <Grid item xs={12}>
                              <Typography className={classes.titreservice}
                                          style={{fontSize: '1.1rem'}}>{s.service.label}</Typography>
                              <Grid container style={{marginTop: '20px'}}>
                                <Grid container style={{marginBottom: '10px'}}>
                                  <Grid item xs={3} sm={3} md={2}>
                                    <Typography style={{
                                      ...
                                      fontSize: '1.1rem',
                                      fontWeight: 'bold',
                                    }}>{this.state[s.service.label + 'Incomes']}€</Typography>
                                  </Grid>
                                  <Grid item xs={9}>
                                ...
                                <Grid container style={{marginBottom: '10px'}}>
                                  <Grid item xs={3} sm={3} md={2}>
                                    <Typography style={{
                                      ...
                                      fontSize: '1.1rem',
                                      fontWeight: 'bold',
                                    }}>{this.state[s.service.label + 'Prestations']}</Typography>
                                  </Grid>
                                  <Grid item xs={9}>
                                ...
                                <Grid container style={{marginBottom: '10px'}}>
                                  <Grid item xs={3} sm={3} md={2}>
                                    <Typography style={{
                                      ...
                                      fontSize: '1.1rem',
                                      fontWeight: 'bold',
                                    }}>{s.number_of_views}</Typography>
                                  </Grid>
                                  <Grid item xs={9}>
                                    <Typography style={{color: '#7E7E7E'}}>Vue(s) du service depuis
                                      l'inscription</Typography>
                                  </Grid>
                                </Grid>
                                <Grid container style={{marginBottom: '10px'}}>
                                  <Grid item xs={3} sm={3} md={2}>
                                    <Typography style={{
                                      ...
                                      fontSize: '1.1rem',
                                      fontWeight: 'bold',
                                    }}>{this.state[s.service.label + 'Reviews']}</Typography>
                                  </Grid>
                                  <Grid item xs={9}>
