...
const MANGOPAY_MESSAGES= {
  ...
  'DOCUMENT_NOT_ACCEPTED'               : "Pièce d'identité invalide : carte d'identité, passeport ou permis de conduire attendu",
...
const getMangopayMessage = msg_id => {
  ...
  return MANGOPAY_MESSAGES[msg_id] || "Erreur inconnue"
}
