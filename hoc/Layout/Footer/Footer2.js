        ...
        return(
            <React.Fragment>
                ...
                <Grid container style={{backgroundColor: '#747474', width: '100%'}}>
                    ...
                    <Grid item xs={4}/><Grid item xs={4}><hr style={{border:'none', backgroundColor: 'white', height: '1px'}}/></Grid><Grid item xs={4}/>
                    <Grid item xs={4}/><Grid item xs={4}><Typography style={{color: 'white', textAlign: 'center', marginBottom: 15}}>© 2019 My-Alfred. All rights reserved.</Typography></Grid><Grid item xs={4}/>
                </Grid>
