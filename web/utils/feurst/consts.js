...
const [VIEW, CREATE, UPDATE, FULL_UPDATE, DELETE, VALIDATE, CONVERT, LINK, HANDLE, CREATE_FOR]=['VIEW', 'CREATE', 'UPDATE', 'FULL_UPDATE', 'DELETE', 'VALIDATE', 'CONVERT', 'LINK', 'HANDLE', 'CREATE_FOR']
...
const USER_ACTIONS={
  ...
  [FEURST_SALES]: lodash.flattenDeep([
    ...
    [CREATE, VIEW, UPDATE, FULL_UPDATE, VALIDATE].map(action => createUserAction(QUOTATION, action, {visibility: RELATED})),
...
module.exports={
  ...
  CONVERT, QUOTATION_VALIDITY, EXPIRED, FULL_UPDATE,
}
