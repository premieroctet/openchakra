        ...
        <Grid container item xl={12} lg={12} md={12} sm={12} xs={12} className={classes.containerImgAndTitle}>
          <Grid container item xl={6} lg={6} md={6} sm={12} xs={12}>
            <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
              <h1 className={classes.title}>{ReactHtmlParser(t('AVOCOTES.title'))}</h1>
            </Grid>
            <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
              <h3 className={classes.subtitle}>{ReactHtmlParser(t('AVOCOTES.subtitle'))}</h3>
            </Grid>
          </Grid>
...
export default withTranslation(null, {withRef: true})(withStyles(styles)(Banner))
