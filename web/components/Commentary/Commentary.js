                      ...
                      <Grid container style={{alignItems: 'center'}}>
                        ...
                        <Grid className={classes.marginLeft}>
                          <Badge classes={{badge: classes.badge}}
                                 badgeContent={alfred_mode ? owner.score : owner.score_client} color="primary">
                            <StyledRating name="read-only" value={notes.global} readOnly className={classes.ratingStyle}
                                          precision={0.5}/>
                          </Badge>
                        </Grid>
                      </Grid>
                ...
                <Grid className={classes.containerAvatarAndAbout}>
                  <Grid style={{display: 'flex', alignItems: 'center'}}>
                    <Grid className={classes.containerNotes}>
                      <Notes alfred_mode={alfred_mode} notes={alfred_mode ? r.note_alfred : r.note_client}
                             key={moment()} styleComponent={styleComponent ? styleComponent : false}/>
                    </Grid>
                  </Grid>
                </Grid>
