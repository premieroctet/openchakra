              ...
              <Grid item xs={12} className={classes.details}>
                <CardContent className={classes.content}>
                  ...
                  <Typography style={{width: '100%'}} variant="body1" color="textSecondary"
                    ...
                    My-Alfred vous permet d'obtenir un complément de revenus en partageant vos passions et vos
                    compétences.
                    Les utilisateurs peuvent identifier vos services, les réserver et vous permettre ainsi de profiter
