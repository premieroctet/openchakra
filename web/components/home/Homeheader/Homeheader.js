    ...
    return (
      <Fragment>
        ...
        <div className={classes.headerhome}>
          <Grid container>
            <Grid item xs={12}>
              <h3 className={classes.homeform} style={{marginTop: 0}}>Et si vous pouviez réserver n'importe quel service
                immédiatement ?</h3>
            </Grid>
            <Grid item xs={12} style={{width: '100%'}}>

              <Grid container alignItems="center">
                <Grid item className={classes.pickerhomelocation} style={{
                  textAlign: 'left',
              ...
              <Grid container style={{marginTop: 20, width: '100%'}}>
                <Grid item className={classes.pickerhomelocation} style={{
                  ...
                  <DatePicker
                    ...
                    customInput={<TextField label="Quel jour ?"
                                            style={{backgroundColor: 'white', fontWeight: 100, width: '100%'}}
                                            variant={'outlined'}/>}
                    locale='fr'
                    showMonthDropdown
              ...
              <Button disabled={!isEmpty(this.state.errors)} onClick={() => this.search()} variant="contained"
        ...
        <div style={{textAlign: 'left'}} className={classes.headerhome2}>
          ...
          <h4 style={{
            ...
            Particuliers ou indépendants ? Créez dès aujourd’hui votre boutique, proposez vos services et arrondissez
            vos fins de mois avec My-Alfred !
          </h4>
        </div>
        ...
        {popopen ? <React.Fragment>
            <div className={classes.paper}>
              <Grid container>
                ...
                <Grid item xs={4} style={{height: '35px'}}><img src={'../../../static/logo_final_My-Alfred.svg'}
                                                                style={{width: 110}} alt={'Logo Bleu'}/></Grid>
                ...
                <Grid item xs={12}>
                  <h2 style={{
                    ...
                    letterSpacing: -2,
                    fontWeight: 'bold',
                  }}>Les réservations ne seront disponible qu'à partir de Novembre</h2>
                </Grid>
                <Grid item xs={5}/>
