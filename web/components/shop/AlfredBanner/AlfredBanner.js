    ...
    const image = banner.map((e, index) => (
      <div key={index}>
        ...
        <div className="legend">
          <p>{e.label}</p>
          <form onSubmit={(event) => this.onSubmitBanner(event)}><input type='hidden' value={e.picture} name='label'/>
...
export default withTranslation('custom', {withRef: true})(withStyles(styles, {withTheme: true})(alfredBanner))
