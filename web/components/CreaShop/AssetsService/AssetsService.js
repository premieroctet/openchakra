                        ...
                        <Grid container>
                          <Grid item xs={12}>
                            <TextField value={this.state.certificationName} className={classes.inputDiplomaCertifResp}
                                       label="Nom du certificat" margin="dense" variant="outlined"
                                       onChange={e => this.handleChange('certificationName', e.target.value)}
                            />
                          </Grid>
                          <Grid item xs={12}>
                            <TextField value={this.state.certificationYear} className={classes.inputDiplomaCertifResp}
                                       label="Année d'obtention" margin="dense" variant="outlined" select
                          ...
                          <Grid item xs={12}>
                            <Grid style={{display: 'flex', alignItems: 'baseline'}}>
                              <label style={{display: 'inline-block', marginTop: 15}} className="forminputs">
                                ...
                                <input id="file"
                                       style={{width: '0.1px', height: '0.1px', opacity: 0, overflow: 'hidden'}}
                                       name="certifaction" type="file" className="form-control"
