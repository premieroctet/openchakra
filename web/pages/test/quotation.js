...
const PRECOS={'type': 'excavatrice', 'mark': 'CATERPILLAR', 'model': '374D L', 'power': 355, 'weight': 75.5,
  ...
  'accessories': {
    ...
    'Bouclier flanc': {'PIN': [{'BOUCLIER DE FLANC A CLAVETER': ['1U0740', 1]}], 'ALL': [{'BOUCLIER DE FLANC': ['TK WH 50', 1]}]},
    'Bouclier talon':
      {'ALL':
        [{'BOUCLIER DE TALON DE GODET': ['PTG 200', 1]}, {'BOUCLIER DE TALON DE GODET': ['PTG 250', 1]}]},
    'Dents':
      {'ALL': [{'Dent': ['TKN13 PE', 5]}, {'Dent': ['TKN13 PR', 5]}, {'Dent': ['TKN13 DPE', 5]}]}}}
