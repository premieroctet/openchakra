                ...
                <Grid item xs={12} md={6} style={{display: 'inline-block'}}>
                  {cards.length ?
                    <React.Fragment>
                      {cards.map((e, index) => (
                        <React.Fragment>
                          {this.state.id_card === e.Id ?
                            <Grid key={index} value={e.Id} onClick={() => {
                      ...
                      {this.state.id_card === this.state.valueother ?
                        <Grid value={this.state.valueother} onClick={() => {
                          this.setState({id_card: 'other'});
                  ...
                  <Grid style={{width: '296px', height: '40px', margin: '20px', position: 'relative'}}>
                    {this.state.cardSelected ?
                      <Button onClick={() => this.payDirect()} type="submit" variant="contained" style={{
                        color: 'white',
                        position: 'absolute',
                        left: 0,
                        right: 0,
                      ...
                      :
                      <Button onClick={() => this.pay()} type="submit" variant="contained" style={{
                        color: 'white',
                        position: 'absolute',
                        left: 0,
                        right: 0,
