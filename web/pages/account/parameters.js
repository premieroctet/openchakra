      ...
      <Fragment>
        <Helmet>
          ...
          <meta property="description"
                content="Configurez votre compte My Alfred, votre boutique et l'ensemble des paramètres de votre compte."/>
        </Helmet>
        <Layout>
          <Grid container className={classes.bigContainer}>
            ...
            <Grid item xs={9} className={classes.containerLeft}>
              ...
              {user.is_alfred ?
                <React.Fragment><Grid container style={{alignItems: 'center'}}>
                  ...
                  <Grid item xs={12} md={4} style={{paddingLeft: 40}}>
                    <Button size={'large'} type={'button'} onClick={() => this.handleClickOpen()} variant="contained"
                            color="secondary"
                            style={{color: 'white'}}>
                      Supprimer
                    </Button>
              ...
              <Grid container style={{alignItems: 'center'}}>
                ...
                <Grid item xs={12} md={4} style={{paddingLeft: 40}}>
                  <Button size={'large'} type={'button'} onClick={() => this.handleClickOpen2()} variant="contained"
                          color="secondary"
                          style={{color: 'white'}}>
                    Désactiver
                  </Button>
