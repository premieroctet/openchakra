                    ...
                    {alfred.slice(this.state.page * this.state.rowsPerPage, this.state.page * this.state.rowsPerPage + this.state.rowsPerPage)
                      .map((e, index) =>
                        <TableRow key={index}>
                          ...
                          <TableCell>
                            <a target="_blank"
                               href={`https://dashboard.mangopay.com/User/${e.alfred.id_mangopay}/Details`}>{e.alfred.id_mangopay}</a>
                            &nbsp;-&nbsp;
                            <a target="_blank"
                               href={`https://dashboard.mangopay.com/User/${e.alfred.mangopay_provider_id}/Details`}>{e.alfred.mangopay_provider_id}</a>
                          </TableCell>
                          <TableCell>
                            {e.alfred.id_card ?
                              <Link href={`/dashboard/alfred/idCard?id=${e.alfred._id}`}
                                    target={`_blank`}><a>Détails</a></Link>
                              :
                              `Aucune`
                            }
                          </TableCell>
                          ...
                          <TableCell>
                            {e.alfred.id_card && e.alfred.id_card_status != KycDocumentStatus.Validated ?
                              <Button color="primary" onClick={() => this.kyc_validation(e.alfred._id)}>Validation
                                Mangopay</Button>
                              :
                              null
                            }
