              ...
              <Paper style={{width: '100%'}}>
                <div>
                  <Table className={classes.table}>
                    ...
                    <TableBody>
                      {service.slice(this.state.page * this.state.rowsPerPage, this.state.page * this.state.rowsPerPage + this.state.rowsPerPage)
                        .map((e, index) =>
                          <TableRow key={index}>
                            ...
                            <TableCell>
                              <Link href={`/dashboard/services/view?id=${e._id}`}><a>Modifier</a></Link>
                            </TableCell>
