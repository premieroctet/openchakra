          ...
          <Card className={classes.card}>
            <Grid>
              <Grid item style={{display: 'flex', justifyContent: 'center'}}>
                <Typography style={{fontSize: 30}}>Filtres de recherche</Typography>
              </Grid>
              <Paper style={{width: '100%'}}>
                <div>
                  <Table className={classes.table}>
                    ...
                    <TableBody>
                      {searchFilter.slice(this.state.page * this.state.rowsPerPage, this.state.page * this.state.rowsPerPage + this.state.rowsPerPage)
                        .map((e, index) =>
                          <TableRow key={index}>
                            ...
                            <TableCell>
                              <Link href={`/dashboard/searchFilter/view?id=${e._id}`}><a>Modifier</a></Link>
                            </TableCell>
              ...
              <Link href={'/dashboard/searchFilter/add'}>
