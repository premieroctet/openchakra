            ...
            <Grid container>
              ...
              <Grid item md={5} xs={12}
                ...
                <Grid className={classes.skillsContentContainer}>
                  <Skills alfred={this.state.alfred} skills={this.state} widthHr={'100%'} hideCount={true}
                ...
                <Grid style={{float: 'left'}} item xs={6}> <Button onClick={() => this.back()} color={'white'}
