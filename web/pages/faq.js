    ...
    return (
      <Layout>
        <Grid container className={classes.bigContainer}>
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        Votre inscription et la mise en ligne de votre boutique sont entièrement gratuites et ne
                        demandent aucun
                        frais au préalable ou abonnement vous engageant sur la durée.

                        Vous pouvez proposer immédiatement vos talents, vos compétences sur My-Alfred en choisissant la
                        liste
                        des services que vous souhaitez proposer. Nous avons répertorié pour vous plus de 2000
                        prestations
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        prestations que vous souhaitez réaliser tout en vous offrant pleine liberté sur vos conditions !
                        Nos Alfred fixent leur(s) prix ainsi que leur(s) méthode(s) de facturation librement, et peuvent
                        ajuster leur(s) prix à tout moment. Afin de proposer une visibilité et une confiance accrue
                        entre les utilisateurs et les Alfred, la boutique de service(s) offre un niveau de
                        personnalisation élevé permettant à tout à chacun de décrire son expertise, ses diplômes et
                        certifications, des options liées à ses services, le matériel fourni dans le cadre de son
                        service ou encore ses disponibilités.
                        Les Alfred sont également libres de choisir leurs propres conditions de réservation et
                        d’annulation !
                      </p>
                      <p>
                        Prêt à vous lancer ?
                        Pour démarrer la création de votre boutique, l’inscription est obligatoire. Une fois identifé(e)
                        sur My-Alfred, il suffit de cliquer sur le bouton “Devenir Alfred’’.

                      </p>
                      <p>
                        Simple et rapide, la création de votre boutique se déroule en 3 étapes et ne vous prendra
                        quelques minutes :
                      </p>
                      <p>
                        Etape 1 : Sélection des services<br/>
                        A travers cette étape, vous pouvez sélectionner les services que vous souhaitez réaliser. Nous
                        avons classé ces services dans des catégories pour vous permettre de trouver plus rapidement les
                        services concernés. Un service n'apparaît pas ?
                        Contacter l’équipe My-Alfred à l’adresse <a
                        href={'mailto:unservicedeplus@my-alfred.io'}>unservicedeplus@my-alfred.io</a> !

                      </p>
                      <p>
                        Etape 2 : Indiquez vos prix, vos disponibilités et conditions<br/>
                        Pour chaque service sélectionné, vous devez renseigner un prix par prestation, vos
                        disponibilités et vos conditions de réservation pour permettre à vos clients de réserver vos
                        services avec un maximum d’informations.
                      ...
                      <p>
                        C’est fini ! Vous avez maintenant votre propre boutique de services sur My-Alfred. A tout
                ...
                >
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <p>
                        Vous pouvez à tout moment visualiser ou modifier le prix et le mode de facturation de vos
                        services dans
                        votre boutique.
                      </p>
                      <p style={{width: '100%'}}>
                ...
                >
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <p>
                        Vous pouvez à tout moment visualiser ou modifier les options de vos services dans votre
                        boutique.
                      </p>
                      <p style={{width: '100%'}}>
                ...
                >
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <p>
                        Vous pouvez à tout moment visualiser ou modifier le montant minimum de vos services dans votre
                        boutique.
                      </p>
                      <p style={{width: '100%'}}>
                ...
                >
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <p>
                        Vous pouvez à tout moment visualiser ou modifier le périmètre d’intervention de vos services
                        dans
                        votre boutique.
                      </p>
                      <p style={{width: '100%'}}>
                ...
                >
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <p>
                        Vous pouvez à tout moment visualiser ou modifier le délai de prévenance de vos services dans
                        votre boutique.
                      </p>
                      <p style={{width: '100%'}}>
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <ol style={{fontFamily: 'Helvetica', fontSize: '0.9rem'}}>
                        ...
                        <li>Cliquez sur l’onglet <strong>Mes services</strong></li>
                        <li>Cliquez sur <strong>Modifier</strong> dans un service</li>
                        <li>Modifiez votre nombre d’années d’expérience, supprimer ou ajouter un diplôme ou une
                          certification
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <p>
                        ...
                        Alfred et n'ont pas reçu de commentaires négatifs.
                ...
                >
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <p>
                        Vous pouvez à tout moment visualiser ou modifier vos conditions d’annulation de vos services
                        dans votre boutique.
                      </p>
                      <p style={{width: '100%'}}>
                      ...
                      <ol style={{fontFamily: 'Helvetica', fontSize: '0.9rem'}}>
                        <li>Consultez <strong>votre Boutique</strong> sur my-alfred.io</li>
                        <li>Cliquez sur l’onglet <strong>Mes paramètres de réservation</strong></li>
                        <li>Sélectionnez le type de condition d’annulation de réservation de vos services puis cliquez
                          sur
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        toute
                        sécurité. C’est la raison pour laquelle , nous vous laissons la possibilité de nous fournir une
                        pièce
                        d’identité officielle lorsque vous êtes utilisateur et souhaitez simplement consommer des
                        services.
                        ...
                        facilement le choix de votre boutique. Cependant, votre pièce d’identité ne sera jamais partagée
                        et
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        carte
                        nationale d’identité soit un passeport. Vous pouvez fournir cette pièce d’identité lors de la
                        création
                        de votre boutique ou plus tard dans le menu Votre profil. La vérification de votre pièce
                        d’identité
                        est indispensable pour Devenir Alfred et pour que votre boutique soit visible des autres autres
                        membres
                        My-Alfred.
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <p>
                        ...
                        le recto et le verso de votre document. Si vous ajoutez votre passeport, 1 seule photo à
                        télécharger
                        est nécessaire mais assurez vous que que les numéros situés en bas de la page du passeport où
                        figure
                ...
                >
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <p>
                        La photo de votre carte d’identité ainsi que les informations (à l’exception de votre nom et
                        prénom)
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        lesquelles les clients ont exigé une pièce d’identité vérifiée, nous annulerons toutes les
                        réservation
                        concernées à venir.
                        Cependant, vous pouvez demander la suppression de la photo de votre pièce d'identité 90 jours
                        après la
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        Lorsque le service est réalisé, votre client doit vous communiquer ce code afin que vous
                        puissiez
                      ...
                      <p>
                        Une fois que vous avez votre code, rendez-vous sur votre fiche réservation depuis votre
                        smartphone
                        ou depuis votre ordinateur et cliquez sur “Indiquer mon code”. Saisissez les chiffres de votre
                        code
                        et validez.
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        Ces éléments vous sont demandés lors de votre inscription et lors de la création de votre
                        boutique.
                      </p>
                      <p style={{width: '100%'}}>
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        utilisateur
                        l’accepte. Si votre utilisateur l’accepte, vous pouvez modifier la date et l’horaire de votre
                        service,
                        son prix, le prix de votre option ou compléter le service par une prestation présente dans votre
                        service.
                      ...
                      <ol style={{fontFamily: 'Helvetica', fontSize: '0.9rem'}}>
                        ...
                        <li>Parcourez votre fiche réservation et cliquez sur modifier en bas de votre fiche de
                          réservation
                        </li>
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        pénalité de la part de votre client utilisateur. Si vous avez activé la réservation automatique
                        sans
                      ...
                      <p>
                        ...
                        de 7 jours avant la date d’exécution définie, une pénalité forfaitaire de 10€ vous sera
                        demandée,
                        et 20€ si l’annulation intervient 7 jours ou moins avant la date d’exécution du service définie
                        dans
                      ...
                      <p>
                        ...
                        totalité des frais engagés sur la plateforme My-Alfred dans le cadre de la réservation
                        concernée.
                      </p>
                      <p style={{width: '100%'}}>
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        confirmation, vous pouvez annuler vos réservations sans pénalités mais un commentaire
                        mentionnant
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        utilisateur
                        doit impérativement accepter cette modification pour que la réservation retrouve son statut
                        confirmée.
                      ...
                      <p>
                        ...
                        de réservation confirmée à réservation en attente jusqu’à ce que votre client utilisateur
                        confirme
                        les modifications.
                      </p>
                      <p>
                        Si votre utilisateur ne valide pas vos modifications dans un délai 48h, la réservation est
                        expirée.
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        créneaux
                        horaires, nous vous recommandons de vous rapprocher de votre client utilisateur afin d’établir
                        ensemble
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        complémentaires
                        sur l’un de vos services. Ils pourront vous contacter mais leurs coordonnées n'apparaîtront pas,
                        et
                        ...
                        En revanche, dès lors qu’une réservation est confirmée, vous pourrez échanger depuis le
                        plateforme
                        My-Alfred, et les coordonnées de votre Alfred ou de l’utilisateur seront échangées pour un
                        maximum
                      ...
                      <p>
                        ...
                        <strong> Messages</strong>. Pour retrouver vos messages en tant qu’Alfred, il vous suffit
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        Si vous êtes Alfred, la suppression du compte implique la suppression de votre boutique,
                        l’annulation
                        de l’ensemble des réservations acceptées à venir, et leur remboursement.
                        Si vous êtes simple utilisateur, la suppression de votre compte implique l’annulation de
                        l’ensemble
                        des réservations acceptées à venir, moyennant - en fonction des conditions d’annulation de(s)
                        Alfred
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      <p>
                        ...
                        téléphonique).
                        Les notifications sont classées par rubrique et vous pouvez choisir à tout moment, de les
                        modifier
                        ou de les désactiver.
                      </p>
                      <p>
                        Seule la rubrique Assistance du compte doit impérativement avoir l’une des options de
                        notifications
                        activée. En effet, dans le cadre de vos réservations de services, des informations légales,
                        des questions de sécurité et de confidentialité, et pour répondre à vos demandes adressées à
                        notre
                        assistance utilisateur, nous devons être en mesure de vous envoyer des messages. Pour votre
                        sécurité,
                ...
                >
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <p>
                        Saisissez votre mot de passe actuel, puis saisissez le nouveau mot de passe, puis répétez le mot
                        de passe.
                  ...
                  <ExpansionPanelDetails>
                    <Grid container>
                      ...
                      <ol style={{fontFamily: 'Helvetica', fontSize: '0.9rem'}}>
                        ...
                        <li>Vérifiez ensuite votre boîte d’emails et cliquez sur ‘’je confirme mon email’’ dans l’email
                          que vous avez reçu.
                        </li>
                      </ol>
                    </Grid>
          ...
          <Grid item xs={5}>
            <Grid className={classes.hideed} container style={{
              position: 'sticky',
              height: '90vh',
              backgroundImage: 'url(../static/illustration-FAQ.svg)',
