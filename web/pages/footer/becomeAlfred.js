            ...
            <Fragment>
                ...
                <Grid style={{display: 'flex', flexDirection: 'column', paddingTop: '30px'}}>
                    <Grid style={{
                        ...
                        <Grid style={{display: 'flex', flexDirection: 'column'}}>
                            <Typography style={{fontWeight: 'bold'}}>Proposez vos services</Typography>
                            <Typography style={{marginTop: '5px'}}>Vous n'avez aucun frais à payer pour proposer vos services.
                    ...
                    <Grid style={{
                        ...
                        <Grid style={{display: 'flex', flexDirection: 'column'}}>
                            <Typography style={{fontWeight: 'bold'}}>Fixez vos conditions</Typography>
                            <Typography style={{marginTop: '5px'}}>Indiquez vos disponibilités (jours, heures...) ainsi que vos
                    ...
                    <Grid style={{
                        ...
                        <Grid style={{display: 'flex', flexDirection: 'column'}}>
                            <Typography style={{fontWeight: 'bold'}}>Choisissez votre Alfred et réservez !</Typography>
                ...
                <Grid style={{
                    ...
                    <Grid style={{
                        ...
                        <Typography>My-Alfred vous permet, de manière simple et sécurisée, de mettre vos services à disposition
                    ...
                    <Grid
                        ...
                        <Typography>Nous sommes tous des Alfred dès l'âge de 16 ans. Chacun d'entre nous doit pouvoir partager
                ...
                <Grid>
                    ...
                    <Grid style={{
                        ...
                        <Grid style={{
                            ...
                            <Typography>A travers la création de votre boutique, vous proposez vos services en décrivant
                        ...
                        <Grid style={{
                            ...
                            <Typography>Vous indiquez vos disponibilités (jours, heures...) ainsi que vos tarifs et tous les
                    ...
                    <Grid style={{
                        ...
                        <Grid style={{
                            ...
                            <Typography>C'est à vous de fixer les prix de vos services : nos outils de tarifications sont là pour
                        ...
                        <Grid style={{
                            ...
                            <Typography>Pour que les utilisateurs de My-Alfred puissent facilement comprendre vos services, vous
