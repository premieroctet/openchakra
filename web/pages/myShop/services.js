...
class services extends React.Component {
  ...
  renderSwitch(stepIndex) {
    ...
    switch (stepIndex) {
      case 0:
        return <SelectService onChange={this.onServiceChanged} creation={this.state.creation} service={shop.service}
                              exclude={this.state.exclude_services} creationBoutique={false}/>;
      case 1:
        return <SelectPrestation service={shop.service} prestations={newService ? {} : shop.prestations}
                                 onChange={this.prestaSelected}/>;
      case 2:
        return <SettingService service={shop.service} equipments={shop.equipments} location={shop.location}
                               travel_tax={shop.travel_tax} pick_tax={shop.pick_tax}
        ...
        <Grid className={classes.mainHeader}>
          ...
          <Grid className={classes.contentStepper}>
            <Stepper activeStep={this.state.activeStep}
                     isType={this.props.service_user_id ? 'updateService' : 'addService'}/>
          </Grid>
        </Grid>
