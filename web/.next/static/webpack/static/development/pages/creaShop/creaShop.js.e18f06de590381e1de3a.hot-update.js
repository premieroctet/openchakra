...
class SelectPrestation extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  componentDidMount() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default.a.get(`/myAlfred/api/prestation/${this.props.service}`).then(res => {
      ...
      let grouped = lodash__WEBPACK_IMPORTED_MODULE_12___default.a.mapValues(lodash__WEBPACK_IMPORTED_MODULE_12___default.a.groupBy(public_prestations, 'filter_presentation.label'), clist => clist.map(public_prestations => lodash__WEBPACK_IMPORTED_MODULE_12___default.a.omit(public_prestations, 'filter_presentation.label')));
...
class SelectService extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  setServices(pattern) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_7___default.a.defaults.headers.common['Authorization'] = react_cookies__WEBPACK_IMPORTED_MODULE_10___default.a.load('token');
...
class SettingService extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  componentDidMount() {
    axios__WEBPACK_IMPORTED_MODULE_8___default.a.defaults.headers.common['Authorization'] = react_cookies__WEBPACK_IMPORTED_MODULE_10___default.a.load('token');
...
/* harmony import */ var react_cookies__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! react-cookies */ "./node_modules/react-cookies/build/cookie.js");
...
class DrawerEditingSchedule extends react__WEBPACK_IMPORTED_MODULE_7___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "onDateSelectionChanged", eventsSelected => {
      ...
      axios__WEBPACK_IMPORTED_MODULE_14___default.a.defaults.headers.common['Authorization'] = react_cookies__WEBPACK_IMPORTED_MODULE_17___default.a.load('token');
...
/* harmony import */ var _material_ui_icons_AddCircleOutline__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @material-ui/icons/AddCircleOutline */ "./node_modules/@material-ui/icons/AddCircleOutline.js");
/* harmony import */ var _material_ui_icons_AddCircleOutline__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_material_ui_icons_AddCircleOutline__WEBPACK_IMPORTED_MODULE_13__);
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class DrawerSchedule extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "componentDidMount", () => {
      const auth = react_cookies__WEBPACK_IMPORTED_MODULE_9___default.a.load('token');
      axios__WEBPACK_IMPORTED_MODULE_10___default.a.defaults.headers.common['Authorization'] = auth;
      axios__WEBPACK_IMPORTED_MODULE_10___default.a.get('/myAlfred/api/availability/currentAlfred').then(res => {
        this.setState({
  ...
  render() {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_SwipeableDrawer__WEBPACK_IMPORTED_MODULE_11__["default"], {
      container: container,
      variant: "temporary",
      anchor: 'bottom',
      open: mobileOpen,
...
/* harmony import */ var react_cookies__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! react-cookies */ "./node_modules/react-cookies/build/cookie.js");
...
/* harmony import */ var _components_Drawer_DrawerAndSchedule_DrawerAndSchedule__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../components/Drawer/DrawerAndSchedule/DrawerAndSchedule */ "./components/Drawer/DrawerAndSchedule/DrawerAndSchedule.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class creaShop extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    ...
    _defineProperty(this, "availabilityCreated", avail => {
      ...
      axios__WEBPACK_IMPORTED_MODULE_17___default.a.defaults.headers.common['Authorization'] = react_cookies__WEBPACK_IMPORTED_MODULE_22___default.a.load('token');
  ...
  componentDidMount() {
    ...
    const token = react_cookies__WEBPACK_IMPORTED_MODULE_22___default.a.load('token');

    if (!getLoggedUserId()) {
      next_router__WEBPACK_IMPORTED_MODULE_20___default.a.push('/login');
    }

    axios__WEBPACK_IMPORTED_MODULE_17___default.a.defaults.headers.common['Authorization'] = token;
  ...
  renderSwitch(stepIndex) {
    ...
    switch (stepIndex) {
      ...
      case 6:
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Drawer_DrawerAndSchedule_DrawerAndSchedule__WEBPACK_IMPORTED_MODULE_23__["default"], {
...
//# sourceMappingURL=creaShop.js.e18f06de590381e1de3a.hot-update.js.map