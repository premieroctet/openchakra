                ...
                axios.get(url+`myAlfred/api/prestation/${serviceUser.service._id}`)
                    .then(result => {
                        ...
                        this.state.prestations.forEach(a => {
                            ...
                            console.log("Setting state for "+a.prestation.label+":"+a.billing);
                            if (index !== -1) {
                                            ...
                                            <h4>{a.label}</h4>
                                                ...
                                                {all_prestations.map((z,index) => {
                                                    if(z.filter_presentation.label !== a.label){
                                                        ...
                                                        console.log("Getting state for "+z.label+":"+this.state[z.label+'billing']);
                                                        return (
                                                            <Grid key={index} className={classes.contentFiltre}>
                                                                ...
                                                                {this.state[z.label] ?
                                                                    ...
                                                                    />
                                                                        ...
                                                                        >
                                                                            {z.billing.map(y => {
                                                                                console.log("Mapping billing "+z.billing);
                                                                                return (
