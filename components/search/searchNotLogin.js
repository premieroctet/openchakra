...
import {DateRangePicker, SingleDatePicker, DayPickerRangeController, VERTICAL_ORIENTATION} from 'react-dates';
                ...
                <Layout>
                    <Grid container className={classes.bigContainer}>
                        <Grid container style={{boxShadow: 'rgba(51, 51, 51, 0.31) 0px 5px 7px -5px', paddingBottom: '10px', paddingTop: '10px', position: 'sticky', top: '55px', backgroundColor: 'white', zIndex: 11}}>
                            ...
                            <Grid container className={classes.respfilter} style={{position: 'sticky', top: '110px', zIndex: 10, background: 'white', height: 60}}>
