...
class editOtherAddress extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            address: '',
    ...
    componentDidMount() {
        ...
        axios
            ...
            .then(res => {
                let user = res.data;
                this.setState({user:user, currentAddress: user.service_address,});
        ...
        return (
                        ...
                        <Grid>
                            <Grid item style={{ display: 'flex', justifyContent: 'center' }}>
                                <Typography style={{ fontSize: 15 }}>Modifier mon autre adresse</Typography>
                            </Grid>
...
export default withStyles(styles)(editOtherAddress);
