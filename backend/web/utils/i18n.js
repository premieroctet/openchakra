const CESU_NOTICE =
  "Quel que soit votre statut, My Alfred est tenu de déclarer aux finances publiques vos revenus générés si les deux conditions suivantes sont réunies dans l'année civile : vos revenus dépassent 3000 euros, vous avez réalisé vingt prestations ou plus";
...
const SCHEDULE_SUBTITLE =
  "Votre calendrier vous permet d’ajouter vos disponibilités. Lorsque vous ajoutez ou modifiez vos disponibilités, seules les plages horaires indiquées pourront être réservées. Vous pouvez très facilement ajouter une période de disponibilité en indiquant les dates de début et fin, les jours correspondants et des tranches horaires. Vous pouvez également sélectionner une date ou plusieurs, indiquer si vous êtes disponible et sélectionner les tranches horaires.";

const SHOP_CREATION_SUCCESSFUL =
  "Vos services sont maintenant disponibles dans my Alfred";

const REGISTRATION_PROOF_CONFIRM_DELETION =
  "Supprimer votre document d'immatriculation ?";

const INFOBAR = {
  message:
    "Vous ne trouvez pas votre service ? L’équipe Alfred se mobilise pour trouver le meilleur Alfred près de chez vous",
  randomTextA: "coucou",
  randomTextB: "commment ça va",
...
const DEFINE_PASSWORD = {
  ...
  title: "Bienvenue !",
  subtitle:
    "L'administrateur My Alfred de votre entreprise vous invite à vous inscrire sur My Alfred.",
  signin_message:
    "Pour finaliser votre inscription, veuillez définir votre mot de passe :",
...
const EVALUATE = {
  ...
  warning_message:
    "Avant publication, les commentaires seront modérés par l'équipe All Inclusive."
};
...
const USERSERVICEPREVIEW = {
  ...
  snackbar_error_avc:
    "Impossible de réserver cet Alfred pour avocôtés, prestations manquantes: ",
  error_presta: "Sélectionnez au moins une prestation",
  error_minimum_basket:
    "Commande minimum des prestation de {{minimum_basket}}€ requise",
  ...
  error_amount_too_high:
    "Le montant dépasse le budget disponible pour votre département",
  error_resa_myself: "Vous ne pouvez pas vous réserver vous-même",
  error_place_far_away:
    "Cet Alfred se trouve trop loin de chez vous pour être réservé!",
  ...
  topic_list_condition_summary:
    " vous permet d’annuler votre réservation jusqu’à ",
  one_day: " 1 jour ",
  five_days: " 5 jours ",
  ten_days: " 10 jours ",
  ...
  minimum_basket_of:
    "Le panier minimum de {{firstname}} est de {{minimum_basket}} €",
  ...
  topic_commentary_summary:
    "Ici, vous pouvez laisser des commentaires à {{firstname}}!"
};
...
const FAQ_ABOUT = {
  ...
  content_mission:
    "Notre mission est de créer un lieu de rencontres et d’opportunités, où trouver la bonne personne n’est plus un problème.",
  title_vision: "Notre vision",
  content_vision:
    "Nous aimerions que My Alfred puisse vous accompagner au quotidien. Notre communauté est au coeur de ce que nous faisons et nous souhaitons créez un espace où règne la confiance et la simplicité."
};
...
const FAQ_BECOME_ALFRED = {
  ...
  one_content:
    "Vous n'avez aucun frais à payer pour proposer vos services. Indiquez simplement vos prestations en vous appuyant sur une liste de plus de 2000 services proposées sur My-Alfred. Un service n'apparaît pas ? Soumettez-le à nos équipes !",
  two: "2",
  two_title: "Fixez vos conditions",
  two_content:
    "Indiquez vos disponibilités (jours, heures...) ainsi que vos tarifs et tous les critères pour définir votre prestation. Si vous avez besoin d'aide, nous sommes là pour vous accompagner dans la création de votre boutique de compétences !",
  three: "3",
  three_title: "Choisissez votre Alfred et réservez !",
  three_content:
    "Choisissez le profil et la prestation qui vous intéresse puis sélectionnez vos dates et vos options. Cliquez sur le bouton réservez et suivez la procédure de paiement",
  ...
  who_become_alfred_content:
    "Nous sommes tous des Alfred dès l'âge de {{age}} ans. Chacun d'entre nous doit pouvoir partager ses savoir faire, ses compétences, ses passions... Tantôt consommateur d'Alfred, tantôt Alfred, rejoignez la communauté Alfred en quelques clics !",
  create_shop: "Créez votre boutique à votre façon",
  propose_service: "Vous proposez vos services",
  propose_service_content:
    "A travers la création de votre boutique, vous proposez vos services en décrivant l'ensemble de vos prestations. Vous pouvez à tout moment revenir sur votre boutique, ajouter ou supprimer des services. Les différentes étapes de création de votre boutique sont extrêmement simples. À vous de jouer !",
  availibility: "Vous affichez vos disponibilités",
  aivailibility_content:
    "Vous indiquez vos disponibilités (jours, heures...) ainsi que vos tarifs et tous les critères pour définir votre prestations. Vous pouvez synchroniser votre calendrier My-Alfred avec vos autres calendriers et éviter de manquer un rendez-vous. Tous vos calendriers sont mis à jour automatiquement",
  your_price: "Vous fixez vos prix",
  your_price_content:
    "C'est à vous de fixer les prix de vos services : nos outils de tarifications sont là pour vous aider à proposer le meilleur prix. Vous pouvez facilement ajouter des éléments personnalisés, notamment des tarifs de week-end, de nuit, des packages de services...",
  your_rules: "Vous déterminez vos règles",
  your_rules_content:
    "Pour que les utilisateurs de My-Alfred puissent facilement comprendre vos services, vous définissez vos règles avant qu'ils puissent réserver. S'ils enfreignent les règles après avoir réservé, vous pourrez annuler leur réservation sans aucune pénalité."
};
...
const ADD_SERVICE = {
  ...
  register_phone:
    "Commencez par vous inscrire en précisant votre adresse et votre numéro de téléphone",
  two: "2",
  begin_your_research: "Commencez votre recherche",
  begin_your_research_content:
    "Indiquez le type de service que vous recherchez dans de recherche et parcourez les différentes catégorie de service",
  three: "3",
  three_title: "Choisissez votre Alfred et réservez !",
  three_content:
    "Choisissez le profil et la prestation qui vous intéresse puis sélectionnez vos dates et vos options. Cliquez sur le bouton réservez et suivez la procédure de paiement"
...
const BANNER_PRESENTATION = {
  ...
  text:
    "Artisans, indépendants, entrepreneurs, étudiants... en quelques clics trouvez la personne et le service dont vous avez besoin.",
  button: "Découvrir"
};
...
const BANNER_B2B_PRESENTATION = {
  ...
  text:
    "Trouvez le prestataire idéal pour répondre aux besoins ponctuels de votre entreprise & de vos collaborateurs. Des milliers de profils vérifiés et qualifiés au service de vos projets, votre stratégie, vos collaborateurs et vos locaux ! Un service simple et sécurisant !",
  button: "Découvrir"
};
...
const HOW_IT_WORKS = {
  leftText:
    "En quelques clics, réservez le service et la personne dont vous avez besoin.#MyAlfred.",
  rightText:
    "Vous pouvez consulter des centaines de profils, choisir votre Alfred, réserver et payer en ligne votre service. Notre équipe vous accompagne à chaque étape !"
};
...
const SERVICES_COMPANY = {
  ...
  title: "Mes services",
  services_available_for:
    "Services disponibles pour {{entity_type}} <strong>{{entity_name}}</strong>",
...
const ABOUT = {
  ...
  b2b_titlesummary_topic:
    "Ici, vous pouvez modifier les informations de votre entreprise",
...
const CALENDAR = {
  ...
  subtitle:
    "Votre calendrier vous permet d’ajouter vos disponibilités en précisant les tranches horaires. "
};
...
const PAYMENT_METHOD = {
  ...
  subtitle:
    "N'hésitez pas à enregistrer un mode de paiement pour aller plus vite lors de vos réservations."
};
...
const REGISTER_SECOND_PAGE = {
  ...
  address_subtitle:
    "Votre adresse ne sera pas visible, mais nous l’utiliserons pour vous proposer ou proposer vos services aux utilisateurs ou Alfred proches de chez vous.",
  ...
  minimum_age_end:
    " ans. Les autres utilisateurs ne verront pas votre date de naissance.",
  textfield_day: "Jour",
  ...
  phone_subtitle:
    "L'ajout de votre numéro de téléphone permet aux membres My-Alfred de disposer d'un moyen pour vous contacter.",
...
const REGISTER_THIRD_PAGE = {
  ...
  subtitle:
    "Inscription réussie ! Vous pouvez maintenant proposer ou rechercher vos services sur My Alfred",
...
const HANDLE_CB = {
  ...
  cb_subtitle_paid:
    "Payez encore plus rapidement sans communiquer vos informations financières.",
  cb_title_dialog_delete:
    "Voulez-vous vraiment supprimer votre carte bancaire ?",
  cb_content_dialog_delete:
  ...
  cb_dialog_crypdata_add:
    "Toutes les données de paiement sur My Alfred sont cryptées.",
  cb_dialog_mongo_add:
    "Elles sont gérées par mangopay notre partenaire de confiance.",
...
const HANDLE_RIB = {
  ...
  dialog_add_rib_data:
    "Toutes les données de paiement sur My Alfred sont chiffrées.",
  dialog_add_rib_mongo:
    "Elles sont gérées par mangopay notre partenaire de confiance.",
  dialog_delete_rib_title: "Voulez-vous vraiment supprimer votre RIB ?",
  dialog_delete_rib_content:
    "Si vous supprimez votre RIB vous ne pourrez plus l'utiliser par la suite avec ce compte.",
  title: "RIB enregistrés",
  b2b_subtitle:
    "Renseignez un rib pour permettre à vos collaborateurs le paiement par prélèvement bancaire.",
...
const TRUST_VERIFICATION = {
  ...
  title: "Vérification",
  subtitle:
    "Vérifiez votre email, votre numéro de téléphone et votre identité.",
  ...
  insert_document:
    "Insérez ici le document d'immatriculation de votre entreprise (extrait de K-Bis, document d'immatriculation de micro-entreprise).",
...
const SECURITY = {
  ...
  dialog_delete_account_content:
    "Attention, cette action est irréversible. Si vous souhaitez ne plus être référencé par les moteurs de recherche, vous pouvez désactiver l’indexation par les moteurs de recherche.",
  dialog_delete_account_confirm: "Désactiver",
  dialog_delete_shop_title: "Supprimer votre boutique ?",
  dialog_delete_shop_content:
    "Attention, cette action est irréversible. Si vous souhaitez garder votre boutique sans que les utilisateurs puissent réserver vos services, vous pouvez supprimer vos disponibilités sur votre calendrier.",
  title: "Sécurité",
  ...
  index_my_account:
    "Je souhaite que mon compte apparaisse dans les résultats des moteurs de recherche",
...
const NOTIFICATIONS = {
  ...
  receive_messages:
    "Recevez des messages de la part des Alfred et des utilisateurs y compris les demandes de réservations.",
  ...
  coupon_title:
    "Recevez des coupons, des informations promotionnelles, des enquêtes, et des informations de la part de My-Alfred et de ses partenaires.",
  ...
  security_conf:
    "Vos réservations, des informations légales, des questions de sécurité et de confidentialité. Pour votre sécurité, vous ne pouvez pas désactiver les notifications par email."
};

const NEWSLETTER = {
  title:
    "Profitez des bons plans de la communauté avec la Newsletter des Alfred",
  text:
    "Inscrivez-vous gratuitement à notre super Newsletter pour recevoir les informations et les bons plans de la communauté.",
...
const CMP_PRESENTATION = {
  placeholder:
    "Ici, parlez-nous de vous, de votre personnalité, de vos passions ou encore de votre parcours. Soyez vous-même et montrez-nous votre personnalité !",
...
const PERSONAL_INFORMATION = {
  ...
  secondary_verification:
    "Faites vérifier votre pièce d’identité et votre numéro de téléphone"
};
...
const SHOP = {
  ...
  bienvenue: {
    ...
    step1_text:
      "Sélectionnez le premier service que vous souhaitez proposer ! Et comme un talent en appelle un autre, vous pourrez ajouter autant de services que vous voulez.",
    step2_main_title: "Etape 2",
    step2_subtitle: "Vous êtes chez vous ! Fixez vos règles et vos conditions…",
    step2_text:
      "Indiquez vos disponibilités, paramètres de réservation et vos conditions d’annulation.",
    step3_main_title: "Etape 3",
    step3_subtitle: "Présentez-vous !",
    step3_text:
      "Renseignez votre profil Alfred, partagez vos réalisations, et décrivez-vous !"
  },
  creation: {
    title: "À propos de vous",
    subtitle:
      "Choisissez votre statut. Les particuliers peuvent proposer leurs services aux particuliers, mais seuls les professionnels peuvent proposer leurs services aux clients particuliers et entreprises.",
    is_particular: "Je suis un particulier",
    is_particular_description:
    ...
    insee_info_end:
      " nous ne pouvons renseigner automatiquement vos informations à partir de votre numéro Siret <br/>Merci de saisir tous les champs manuellement",
    siret: "Siret/Siren",
    name: "Nom"
  },
  service: {
    ...
    subtitle:
      "Sélectionnez votre service, vous pouvez saisir des mots-clés pour faciliter la recherche. Si vous souhaitez en proposer plusieurs, vous pourrez en ajouter autant que vous le souhaitez par la suite.",
    subtitle_update: "Vous allez modifier le service indiqué ci-dessous",
    content_particular: "Liste des services aux particuliers",
    explanation:
      "Vous pouvez saisir un mot clé pour filtrer votre service ou sélectionner votre service dans la liste",
    content_professional: "Liste des services aux entreprises",
    content_particular_professional:
      "Liste des services aux particuliers & aux entreprises",
  ...
  parameter: {
    ...
    subtitle:
      "Indiquez vos tarifs et votre méthode de facturation. Si vous êtes assujetti à la TVA, merci d’indiquer vos tarifs hors taxes. Vous ne trouvez pas une prestation ? Créez une prestation personnalisée qui vous sera propre ! ",
  ...
  settingService: {
    ...
    subtitle:
      "Indiquez votre périmètre d’intervention ainsi que les options qui s’offrent à votre client quant à votre service.",
    ...
    service_withVisio:
      "En visioconférence(ne tient pas compte de votre rayon d’intervention)",
    service_withElearning:
      "En e-learning(ne tient pas compte de votre rayon d’intervention)",
  ...
  preferences: {
    title: "Préférences",
    subtitle:
      "Indiquez vos préférences de réservation. Ces préférences s’appliqueront lorsqu’un client souhaite vous réserver.",
    title_delay_prevenance:
      "De quel délai souhaitez-vous disposer entre la réservation et la réalisation du services ?",
    example_delay:
    ...
    days: "jour(s)",
    weeks: "semaine(s)",
    title_minimum_basket:
      "Quel est le montant minimal pour réserver votre service ?",
    subtitle_minimum_basket:
      " Le montant minimum de réservation correspond au panier minimum requis pour réserver ce service. Si vous indiquez un montant de 10€, les clients ne pourront pas réserver vos services si la somme des prestations n’atteint pas ce montant",
  ...
  assets: {
    title: "Vos atouts",
    subtitle:
      "Mettez en évidence vos compétences et votre expertise dans ce service. Vous pouvez également donner des précisions sur vos prestations. Précisez tout ce qui peut aider votre client à réserver correctement votre service !",
    ...
    diploma_subtitle:
      "En téléchargeant votre diplôme, celui-ci aura le statut de diplôme vérifié auprès des utilisateurs mais il ne sera jamais visible par ces derniers.",
    year_obtain: "Année",
    button_joinDiploma: "Joindre un diplôme",
    certification_title: "Votre certification",
    certification_subtitle:
      "En téléchargeant votre certification, celle-ci aura le statut de certification vérifiée auprès des utilisateurs mais elle ne sera jamais visible par ces derniers.",
  ...
  bookingCondition: {
    ...
    subtitle:
      "Fixez vos conditions et la façon dont vous acceptez qu’un client réserve vos services.",
    ...
    booking_auto:
      "Les utilisateurs peuvent réserver mes services directement sans demande de réservation.",
    title_secondSection:
      "Quelles sont les conditions pour réserver vos services ?",
    ...
    condition_flexible:
      "Flexibles: Remboursement intégral jusqu'à 1 jour avant la prestation",
    condition_moderate:
...
const ASK_QUESTION = {
  ...
  info:
    "Rendez-vous sur la page du service qui vous intéresse, cliquez sur « demande d’informations » en dessous du bouton réserver. Vous pourrez alors poser toutes vos questions à {{firstname}} !"
};
...
const STATISTICS = {
  ...
  subtitle_topic_incomes:
    "Ici, vous pouvez suivre l'évolution de vos revenus et vos statistiques prévisionnelles",
  year: "Année",
  month: "Mois",
  ...
  my_stat_subtitle:
    "Retrouvez vos nombres de vues, de commentaires ou encore de prestations réalisées",
...
const EMPLOYEE_DIALOG = {
  ...
  subtitle:
    "Importez la liste des collaborateurs à partir d'un fichier csv séparé par des points-virgules.<br/>Les colonnes nom, prénom et email sont requises.",
  button: "Importer"
};
...
const AVOCOTES = {
  title:
    "Besoin d'un coup de pouce pour installer votre pack AvoCotés protection ?",
  subtitle:
    "Confiez l'installation de votre Pack SECURITE AvoCotés Protection à un entrepeneur local & qualifé",
  titleSection: "À propos de l'installateur",
  description:
    "Alfred on-demand est partenaire d'AvoCotés pour toutes les demandes d'installation de matériel de télésurveillance. Nos entrepreneurs sont des indépendants locaux, qualifiés et vérifiés par nos équipes. Chaque entrepreneur est formé à l'installation du matériel AvoCotés par nos soins.",
  descriptionSecond:
    "Notre équipe vous contacte par téléphone afin de fixer avec vous un créneau qui s'intégre à vos impératifs. Pour toute question relative à votre installation, n'hésitez pas à nous contacter au 06 87 37 73 63.",
  ...
  ourCompanyDescriptionFirst:
    "Grâce à notre communauté d'entrepreneurs indépendants, quel que soit votre besoin en matière de services, Alfred on-demand y répond et vous accompagne dans votre démarche.",
  ourCompanyDescriptionSecond:
    "Nous sélectionnons pour vous les meilleurs talents en parfaite adéquation avec vos besoins, en essayant de nous adpater aux mieux à vos contraintes d'agenda. Nos installateurs sont vérifiés et formés aux solutions AvoCotés pour vous prêter main-forte dans le cadre de votre installation.",
...
const BOOKING = {
  MSG_EVALUATE:
    "Vous avez 15 jours pour évaluer votre client. Une fois que votre client aura rédigé son commentaire, il pourra consulter votre évaluation et vous pourrez consulter la sienne !",
  ...
  info_commentary:
    "Vous avez 15 jours pour évaluer votre Alfred. Une fois que votre Alfred aura rédigé son commentaire, il pourra consulter votre évaluation et vous pourrez consulter la sienne !",
  ...
  versement: "Versement",
  search_presta:
    "Nous allons maintenant chercher pour vous l'Alfred qui répondra à votre service.Vous serez informé sous peu de la date de prestation."
};
