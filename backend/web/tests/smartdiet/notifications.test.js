...
describe('Notifications ', () => {
  ...
  it(`must send notifications`, async() => {
    ...
    const start_date=moment().add(15, 'day'), end_date=moment().add(16, 'day')
    ...
    const webinarToday=await Webinar.create({...WEBINAR_DATA, start_date:moment(), end_date:moment().add(1, 'day'), user})
