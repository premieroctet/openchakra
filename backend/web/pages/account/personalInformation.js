    ...
    return(
      <React.Fragment>
        <LayoutMobile currentIndex={4}>
          <Grid>
            <Grid>
              <h2 style={{whiteSpace: 'nowrap'}}>{ReactHtmlParser(this.props.t('PERSONAL_INFORMATION.title'))}</h2>
            </Grid>
          </Grid>
...
export default withTranslation(null, {withRef: true})(personalInformation)
